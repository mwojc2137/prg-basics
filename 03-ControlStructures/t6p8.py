...
#
person1_name = input('Enter first persons name: ')
person1_age = int(input('Enter first persons age: '))
person2_name = input('Enter second persons name: ')
person2_age = int(input('Enter second persons age: '))
